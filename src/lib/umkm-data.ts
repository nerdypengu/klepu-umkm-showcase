...
export const umkmList: Umkm[] = [
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Pasokan bahan", value: "Pemasok lokal sedang didata" },
    ...
    operations: [
      ...
      { label: "Legalitas", value: "Izin edar, komposisi, dan masa simpan sedang diproses" },
  ...
  },
  {
    ...
    risks: ["Kapasitas manual", "Mutu hasil penggorengan", "Dokumen legalitas sedang disiapkan"],
    ...
    operations: [
      ...
      { label: "Legalitas", value: "NIB, PIRT, dan sertifikasi halal sedang diproses" },
    ],
    roles: [
  ...
  },
  {
    ...
    risks: ["Kapasitas produksi sedang dipetakan", "Rincian bahan dan biaya sedang disusun", "Pasar sedang diperluas"],
  ...
  },
  {
    ...
    risks: ["Profil usaha sedang disempurnakan", "Data produk dan penjualan sedang dicatat"],
