...
export const umkmList: Umkm[] = [
  {
    ...
    facts: [
      ...
      { label: "Digital", value: "WhatsApp dan Shopee" },
    ],
    operations: [
      { label: "Bahan baku", value: "Kopi Liberika dari petani Desa Klepu melalui jaringan pemasok desa" },
      ...
      { label: "Legalitas", value: "NIB telah didaftarkan dan tersedia" },
    ],
  },
  {
    id: "UMKM-002",
    ...
    facts: [
      ...
      { label: "Kapasitas", value: "Kapasitas produksi dapat ditingkatkan sesuai permintaan" },
  ...
  },
  {
    ...
    risks: ["Skala pasokan bahan baku", "Perhitungan HPP per kemasan", "Legalitas dan masa simpan produk"],
    ...
    facts: [
      ...
      { label: "Pasokan bahan", value: "Pemasok lokal di Desa Klepu" },
      { label: "Kapasitas dan penjualan", value: "Dapat disesuaikan dengan permintaan" },
      { label: "Penilaian kesiapan", value: "Dalam pengembangan aktif" },
    ],
    operations: [
      { label: "Bahan baku", value: "Daun kelor (POT-010) dan kayu secang (POT-011); tersedia dari lingkungan desa" },
      { label: "Kebutuhan alat", value: "Pengering, grinder, dan alat pengemas" },
      { label: "Legalitas", value: "Pengurusan izin edar dan informasi komposisi didampingi pemerintah desa" },
  ...
  },
  {
    ...
    prerequisites: ["Perhitungan HPP", "Catatan penjualan", "Dokumen NIB, PIRT, dan halal", "Penawaran harga alat"],
    facts: [
    ...
    operations: [
      ...
      { label: "Legalitas", value: "NIB, PIRT, dan sertifikasi halal didampingi pemerintah desa" },
    ],
    roles: [
  ...
  },
  {
    ...
    risks: ["Peningkatan kapasitas produksi", "Penataan rincian bahan dan biaya", "Perluasan pasar suvenir"],
    mitigations: ["Pendataan waktu kerja", "Katalog ukuran dan warna", "Kurasi suvenir", "Uji pasar wisata"],
    prerequisites: ["Profil pengrajin", "Kapasitas produksi", "Perhitungan biaya produksi", "Data pasar"],
    ...
    facts: [
      ...
      { label: "Kapasitas", value: "Dapat ditingkatkan sesuai pesanan" },
      { label: "Penilaian kesiapan", value: "Dalam pengembangan aktif" },
    ],
    operations: [
  ...
  },
  {
    ...
    risks: ["Penguatan profil usaha", "Penataan data produk dan penjualan"],
    mitigations: ["Wawancara pemilik", "Inventarisasi produk", "Pencatatan produksi dan pasar"],
    prerequisites: ["Identitas pemilik/pengelola", "Daftar produk", "Kapasitas layanan", "Kebutuhan dana"],
    facts: [
